...
export const metadata: Metadata = {
  title: "Blooming Brands | (PPC) Pay Per Click Ads",
  description:
...
const PayPerClickService = () => {
  return (
    <>
      <PageTop PageMessage="Pay Per Click Advertisment" />
      <div className="container mx-auto py-20 flex flex-col lg:flex-row bg-[url('https://img.freepik.com/free-vector/global-network-world-concept-technology-globe-with-continents-map-connection-lines-dots-point-digital-data-planet-design-simple-flat-style-monochrome-color_333792-95.jpg')] bg-top bg-fixed bg-cover bg-no-repeat ">
        <div className="w-full px-4 lg:w-1/2 lg:px-0">
          <h2 className="text-3xl font-black mb-6">
            Supercharge Your Business with Targeted Pay-Per-Click Advertising
          </h2>
          ...
          <p>
            At Blooming Brands, we help businesses like yours drive immediate
            results with expertly crafted Pay-Per-Click (PPC) advertising
            campaigns. Whether you&apos;re looking to increase sales, generate
            more leads, or boost website traffic, our PPC solutions are designed
            to reach the right audience at the right time. Serving businesses
            across New England—including Boston, Lowell, and beyond—we manage
            every aspect of your PPC campaigns to ensure maximum return on
            investment (ROI).
          </p>
        </div>
