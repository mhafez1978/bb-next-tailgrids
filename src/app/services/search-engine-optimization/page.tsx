...
export const metadata: Metadata = {
  title: "Blooming Brands | (SEO) Search Engine Optimization",
  description:
...
const SearchEngineOptimizationService = () => {
  return (
    <>
      <PageTop PageMessage="Search Engine Optimization" />
      <div className="container mx-auto py-20 flex flex-col lg:flex-row bg-[url('https://img.freepik.com/free-vector/global-network-world-concept-technology-globe-with-continents-map-connection-lines-dots-point-digital-data-planet-design-simple-flat-style-monochrome-color_333792-95.jpg')] bg-top bg-fixed bg-cover bg-no-repeat ">
        <div className="w-full px-4 lg:w-1/2 lg:px-0">
          <h2 className="text-3xl font-black mb-6">
            Boost Your Online Brand Visibility with Expert SEO Services
          </h2>
          ...
          {/* <ol className="space-y-3">
            ...
            <p className="mb-8">
              ...
              just an online presence—it’s the heart of your brand. That’s why
              we take a personalized approach to every project. Our team works
              closely with you to create a website that reflects your business's
              identity and values, ensuring you stand out in the competitive New
              England market.
            </p>
            ...
            <p className="">
              When you partner with Blooming Brands, you're never alone. From
              the initial design consultation to post-launch support, we’re here
              every step of the way to ensure your website remains fresh,
              functional, and up to date. We’re committed to building
              long-lasting relationships and helping your business grow.
            </p>
          </ol> */}
          <p>
            In today&apos;s competitive digital landscape, showing up on the
            first page of search results is crucial to driving traffic and
            growing your business. At Blooming Brands, we offer comprehensive
            Search Engine Optimization (SEO) services that help businesses in
            Boston, Lowell, and throughout New England climb the rankings and
            attract more customers. Whether you&apos;re looking to improve your
            local presence or reach a global audience, our SEO strategies are
...
export default SearchEngineOptimizationService;
