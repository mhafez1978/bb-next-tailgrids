...
const CookiesConcentNotice = () => {
  ...
  return (
    <>
      {hide && (
        <section className="fixed bottom-0 bg-black text-white w-screen z-50 pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
          {open && (
              ...
              <div className="flex flex-wrap items-center justify-between rounded-lg bg-primary px-6 py-8 xs:px-10 md:px-8 lg:px-10">
                  ...
                  <div className="mb-6 items-center sm:flex md:mb-0">
                    ...
                    <div>
                      ...
                      <p className="text-base text-white">
                        ...
                        usage, and personalize content. By clicking “Accept” you
                        agree to the storing of cookies on your device to
                ...
                <div className="w-full md:w-5/12 lg:w-1/3">
                  <div className="flex items-center space-x-3 md:justify-end">
                    <button
                      onClick={handleHide}
                      className="inline-flex items-center justify-center rounded-md bg-white px-7 py-3 text-center text-base font-medium text-body-color shadow-1 hover:bg-gray-2 hover:text-sky-500 dark:bg-dark-2 dark:text-dark-6 dark:shadow-none"
                    >
                      Accept
                    </button>
                    <button
...
export default CookiesConcentNotice;
