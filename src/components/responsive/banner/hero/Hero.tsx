  ...
  return (
    <>
      <section className="w-screen h-[100vh] bg-[url('https://i.pinimg.com/originals/c5/9a/d2/c59ad2bd4ad2fbacd04017debc679ddb.gif')] bg-center bg-cover bg-fixed bg-no-repeat">
        <div className="w-full h-full bg-slate-100/80 text-black flex flex-col justify-center">
          <div className="w-full h-[40vh] flex flex-col items-center justify-center px-4 gap-6 lg:w-6/12 lg:mx-auto lg:px-0 lg:-mt-[20vh]">
            <h1 className="text-4xl font-black text-center text-slate-800 capitalize lg:text-8xl">
              We help you get more customers
            </h1>
            <p className="px-4 text-center text-base font-semibold lg:px-4 lg:w-3/4 lg:mx-auto">
              We leverage technology and captivating digital art to elevate your
              brand&apos;s message and online presence by creating visually
              compelling and highly functional websites.
            </p>
            <div className="w-full flex flex-col items-center gap-4 justify-center lg:flex-row lg:gap-2 ">
              ...
              <div className="w-full flex flex-col gap-4 justify-center items-center lg:w-1/2 lg:flex-row">
                ...
                <button className="w-full flex flex-row gap-2 items-center justify-center px-8 py-3 rounded-lg bg-gradient-to-r from-red-400 to-red-600 shadow-lg border-2 border-red-700 text-white text-lg font-bold hover:shadow-2xl transition-transform duration-300 transform hover:scale-110 lg:w-1/2">
